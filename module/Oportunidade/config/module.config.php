...
return array(
        ...
        'routes' => array(
            'oportunidades' => array(
                ...
                'options' => array(
                    'route'    => '/oportunidade',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Oportunidade\Controller',
                        'controller'    => 'Oportunidade',
                        'action'        => 'cadastrarOportunidade',
                    ),
                ),
                'may_terminate' => true,
                'child_routes' => array(
            ...
            'perfilOportunidade' => array(
                'type'    => 'Literal',
                'options' => array(
                    'route'    => '/perfilOportunidade',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Oportunidade\Controller',
                        'controller'    => 'Oportunidade',
                        'action'        => 'oportunidade',
    ...
    'controllers' => array(
        'invokables' => array(
            'Oportunidade\Controller\Oportunidade' => Controller\OportunidadeController::class
